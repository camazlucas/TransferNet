...
def load_data(input_dir, bert_name, batch_size):
    ...
    if os.path.exists(cache_fn):
        ...
        train_data = DataLoader(input_dir, os.path.join(input_dir, '2-hop/qa_train_metaqa_2hop.txt'), bert_name, ent2id, rel2id, batch_size, training=True)
        test_data = DataLoader(input_dir, os.path.join(input_dir, '2-hop/qa_valid_metaqa_2hop.txt'), bert_name, ent2id, rel2id, batch_size)
